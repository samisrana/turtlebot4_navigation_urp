...
bool cdr_serialize_nav2_msgs__srv__LoadMap_Request(
  const nav2_msgs__srv__LoadMap_Request * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
bool cdr_deserialize_nav2_msgs__srv__LoadMap_Request(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs__srv__LoadMap_Request * ros_message)
{
  // Field name: map_url
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
bool cdr_serialize_key_nav2_msgs__srv__LoadMap_Request(
  const nav2_msgs__srv__LoadMap_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: map_url
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
size_t get_serialized_size_key_nav2_msgs__srv__LoadMap_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LoadMap_Request__ros_msg_type * ros_message = static_cast<const _LoadMap_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
size_t max_serialized_size_key_nav2_msgs__srv__LoadMap_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav2_msgs__srv__LoadMap_Request * ros_message = static_cast<const nav2_msgs__srv__LoadMap_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav2_msgs__srv__LoadMap_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav2_msgs__srv__LoadMap_Request * ros_message = static_cast<nav2_msgs__srv__LoadMap_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav2_msgs__srv__LoadMap_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
bool cdr_serialize_nav2_msgs__srv__LoadMap_Response(
  const nav2_msgs__srv__LoadMap_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: map
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
bool cdr_deserialize_nav2_msgs__srv__LoadMap_Response(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs__srv__LoadMap_Response * ros_message)
{
  // Field name: map
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
bool cdr_serialize_key_nav2_msgs__srv__LoadMap_Response(
  const nav2_msgs__srv__LoadMap_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: map
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
size_t get_serialized_size_key_nav2_msgs__srv__LoadMap_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LoadMap_Response__ros_msg_type * ros_message = static_cast<const _LoadMap_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
size_t max_serialized_size_key_nav2_msgs__srv__LoadMap_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav2_msgs__srv__LoadMap_Response * ros_message = static_cast<const nav2_msgs__srv__LoadMap_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav2_msgs__srv__LoadMap_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav2_msgs__srv__LoadMap_Response * ros_message = static_cast<nav2_msgs__srv__LoadMap_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav2_msgs__srv__LoadMap_Response(cdr, ros_message);
}
...
using _LoadMap_Event__ros_msg_type = nav2_msgs__srv__LoadMap_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
bool cdr_serialize_nav2_msgs__srv__LoadMap_Event(
  const nav2_msgs__srv__LoadMap_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_nav2_msgs__srv__LoadMap_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_nav2_msgs__srv__LoadMap_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
bool cdr_deserialize_nav2_msgs__srv__LoadMap_Event(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs__srv__LoadMap_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      nav2_msgs__srv__LoadMap_Request__Sequence__fini(&ros_message->request);
    }
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_nav2_msgs__srv__LoadMap_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      nav2_msgs__srv__LoadMap_Response__Sequence__fini(&ros_message->response);
    }
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_nav2_msgs__srv__LoadMap_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
size_t get_serialized_size_nav2_msgs__srv__LoadMap_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_nav2_msgs__srv__LoadMap_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_nav2_msgs__srv__LoadMap_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
size_t max_serialized_size_nav2_msgs__srv__LoadMap_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_nav2_msgs__srv__LoadMap_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_nav2_msgs__srv__LoadMap_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs__srv__LoadMap_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
bool cdr_serialize_key_nav2_msgs__srv__LoadMap_Event(
  const nav2_msgs__srv__LoadMap_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_nav2_msgs__srv__LoadMap_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_nav2_msgs__srv__LoadMap_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
size_t get_serialized_size_key_nav2_msgs__srv__LoadMap_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LoadMap_Event__ros_msg_type * ros_message = static_cast<const _LoadMap_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_nav2_msgs__srv__LoadMap_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_nav2_msgs__srv__LoadMap_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
size_t max_serialized_size_key_nav2_msgs__srv__LoadMap_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_nav2_msgs__srv__LoadMap_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_nav2_msgs__srv__LoadMap_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav2_msgs__srv__LoadMap_Event * ros_message = static_cast<const nav2_msgs__srv__LoadMap_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav2_msgs__srv__LoadMap_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav2_msgs__srv__LoadMap_Event * ros_message = static_cast<nav2_msgs__srv__LoadMap_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav2_msgs__srv__LoadMap_Event(cdr, ros_message);
}

static uint32_t _LoadMap_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nav2_msgs__srv__LoadMap_Event(
      untyped_ros_message, 0));
}
...
static size_t _LoadMap_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nav2_msgs__srv__LoadMap_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nav2_msgs, srv, LoadMap_Event)() {
