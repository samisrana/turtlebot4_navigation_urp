...
#include "nav2_msgs/msg/detail/costmap__rosidl_typesupport_fastrtps_c.h"
...
#include "nav2_msgs/msg/detail/costmap_meta_data__functions.h"  // metadata
...
using _Costmap__ros_msg_type = nav2_msgs__msg__Costmap;
  ...
  nav2_msgs__msg__Costmap * ros_message)
{
  ...
  // Field name: metadata
  {
    cdr_deserialize_nav2_msgs__msg__CostmapMetaData(cdr, &ros_message->metadata);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav2_msgs__msg__Costmap;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav2_msgs__msg__Costmap * ros_message = static_cast<const nav2_msgs__msg__Costmap *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav2_msgs__msg__Costmap(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav2_msgs__msg__Costmap * ros_message = static_cast<nav2_msgs__msg__Costmap *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav2_msgs__msg__Costmap(cdr, ros_message);
}

static uint32_t _Costmap__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nav2_msgs__msg__Costmap(
      untyped_ros_message, 0));
}

static size_t _Costmap__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_nav2_msgs__msg__Costmap(
