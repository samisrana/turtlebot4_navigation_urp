...
nav2_msgs__action__FollowGPSWaypoints_Goal__init(nav2_msgs__action__FollowGPSWaypoints_Goal * msg)
{
  ...
  msg->goal_index = 0ul;
  // gps_poses
  if (!geographic_msgs__msg__GeoPose__Sequence__init(&msg->gps_poses, 0)) {
    nav2_msgs__action__FollowGPSWaypoints_Goal__fini(msg);
    return false;
  }
  return true;
}
...
nav2_msgs__action__FollowGPSWaypoints_Goal__fini(nav2_msgs__action__FollowGPSWaypoints_Goal * msg)
{
  ...
  // goal_index
  // gps_poses
  geographic_msgs__msg__GeoPose__Sequence__fini(&msg->gps_poses);
}
...
nav2_msgs__action__FollowGPSWaypoints_Goal__are_equal(const nav2_msgs__action__FollowGPSWaypoints_Goal * lhs, const nav2_msgs__action__FollowGPSWaypoints_Goal * rhs)
{
  ...
  // gps_poses
  if (!geographic_msgs__msg__GeoPose__Sequence__are_equal(
  ...
  nav2_msgs__action__FollowGPSWaypoints_Goal * output)
{
  ...
  // gps_poses
  if (!geographic_msgs__msg__GeoPose__Sequence__copy(
...
nav2_msgs__action__FollowGPSWaypoints_Goal__create(void)
{
  ...
  nav2_msgs__action__FollowGPSWaypoints_Goal * msg = (nav2_msgs__action__FollowGPSWaypoints_Goal *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(nav2_msgs__action__FollowGPSWaypoints_Goal));
  bool success = nav2_msgs__action__FollowGPSWaypoints_Goal__init(msg);
  if (!success) {
...
nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence__init(nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_Goal * data = NULL;

  if (size) {
    data = (nav2_msgs__action__FollowGPSWaypoints_Goal *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__FollowGPSWaypoints_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = nav2_msgs__action__FollowGPSWaypoints_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        nav2_msgs__action__FollowGPSWaypoints_Goal__fini(&data[i - 1]);
      }
...
nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence__fini(nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      nav2_msgs__action__FollowGPSWaypoints_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence * array = (nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence__init(array, size);
  if (!success) {
...
nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence__destroy(nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence__are_equal(const nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence * lhs, const nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  nav2_msgs__action__FollowGPSWaypoints_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__FollowGPSWaypoints_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__FollowGPSWaypoints_Goal * data =
      (nav2_msgs__action__FollowGPSWaypoints_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowGPSWaypoints_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowGPSWaypoints_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_Goal__copy(
...
nav2_msgs__action__FollowGPSWaypoints_Result__init(nav2_msgs__action__FollowGPSWaypoints_Result * msg)
{
  ...
  if (!nav2_msgs__msg__MissedWaypoint__Sequence__init(&msg->missed_waypoints, 0)) {
    nav2_msgs__action__FollowGPSWaypoints_Result__fini(msg);
    return false;
  }
  // error_code
  // error_msg
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_Result * msg = (nav2_msgs__action__FollowGPSWaypoints_Result *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(nav2_msgs__action__FollowGPSWaypoints_Result));
  bool success = nav2_msgs__action__FollowGPSWaypoints_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_Result__Sequence__init(nav2_msgs__action__FollowGPSWaypoints_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_Result * data = NULL;

  if (size) {
    data = (nav2_msgs__action__FollowGPSWaypoints_Result *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__FollowGPSWaypoints_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = nav2_msgs__action__FollowGPSWaypoints_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        nav2_msgs__action__FollowGPSWaypoints_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_Result__Sequence__fini(nav2_msgs__action__FollowGPSWaypoints_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      nav2_msgs__action__FollowGPSWaypoints_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_Result__Sequence * array = (nav2_msgs__action__FollowGPSWaypoints_Result__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = nav2_msgs__action__FollowGPSWaypoints_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_Result__Sequence__destroy(nav2_msgs__action__FollowGPSWaypoints_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    nav2_msgs__action__FollowGPSWaypoints_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
nav2_msgs__action__FollowGPSWaypoints_Result__Sequence__are_equal(const nav2_msgs__action__FollowGPSWaypoints_Result__Sequence * lhs, const nav2_msgs__action__FollowGPSWaypoints_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  nav2_msgs__action__FollowGPSWaypoints_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__FollowGPSWaypoints_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__FollowGPSWaypoints_Result * data =
      (nav2_msgs__action__FollowGPSWaypoints_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowGPSWaypoints_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowGPSWaypoints_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_Feedback * msg = (nav2_msgs__action__FollowGPSWaypoints_Feedback *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(nav2_msgs__action__FollowGPSWaypoints_Feedback));
  bool success = nav2_msgs__action__FollowGPSWaypoints_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_Feedback__destroy(nav2_msgs__action__FollowGPSWaypoints_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    nav2_msgs__action__FollowGPSWaypoints_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence__init(nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_Feedback * data = NULL;

  if (size) {
    data = (nav2_msgs__action__FollowGPSWaypoints_Feedback *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__FollowGPSWaypoints_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = nav2_msgs__action__FollowGPSWaypoints_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        nav2_msgs__action__FollowGPSWaypoints_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence__fini(nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      nav2_msgs__action__FollowGPSWaypoints_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence * array = (nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence__destroy(nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence__are_equal(const nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence * lhs, const nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  nav2_msgs__action__FollowGPSWaypoints_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__FollowGPSWaypoints_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__FollowGPSWaypoints_Feedback * data =
      (nav2_msgs__action__FollowGPSWaypoints_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowGPSWaypoints_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowGPSWaypoints_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__init(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!nav2_msgs__action__FollowGPSWaypoints_Goal__init(&msg->goal)) {
    nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__fini(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request * msg)
{
  ...
  // goal
  nav2_msgs__action__FollowGPSWaypoints_Goal__fini(&msg->goal);
}
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__are_equal(const nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request * lhs, const nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!nav2_msgs__action__FollowGPSWaypoints_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request * msg = (nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request));
  bool success = nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence__init(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request * data = NULL;

  if (size) {
    data = (nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence__fini(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence * array = (nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence__destroy(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence__are_equal(const nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence * lhs, const nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request * data =
      (nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__init(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response * msg = (nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response));
  bool success = nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence__init(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response * data = NULL;

  if (size) {
    data = (nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence__fini(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence * array = (nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence__destroy(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence__are_equal(const nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence * lhs, const nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response * data =
      (nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__init(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__fini(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event * msg)
{
  ...
  // request
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence__fini(&msg->response);
}
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__are_equal(const nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event * lhs, const nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event * rhs)
{
  ...
  // request
  if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence__are_equal(
  ...
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event * output)
{
  ...
  // request
  if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event * msg = (nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event));
  bool success = nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence__init(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event * data = NULL;

  if (size) {
    data = (nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence__fini(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence * array = (nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence__destroy(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence__are_equal(const nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence * lhs, const nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event * data =
      (nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__init(nav2_msgs__action__FollowGPSWaypoints_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Request * msg = (nav2_msgs__action__FollowGPSWaypoints_GetResult_Request *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Request));
  bool success = nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence__init(nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Request * data = NULL;

  if (size) {
    data = (nav2_msgs__action__FollowGPSWaypoints_GetResult_Request *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence__fini(nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence * array = (nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence__destroy(nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence__are_equal(const nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence * lhs, const nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__FollowGPSWaypoints_GetResult_Request * data =
      (nav2_msgs__action__FollowGPSWaypoints_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__init(nav2_msgs__action__FollowGPSWaypoints_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!nav2_msgs__action__FollowGPSWaypoints_Result__init(&msg->result)) {
    nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__fini(nav2_msgs__action__FollowGPSWaypoints_GetResult_Response * msg)
{
  ...
  // status
  // result
  nav2_msgs__action__FollowGPSWaypoints_Result__fini(&msg->result);
}
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__are_equal(const nav2_msgs__action__FollowGPSWaypoints_GetResult_Response * lhs, const nav2_msgs__action__FollowGPSWaypoints_GetResult_Response * rhs)
{
  ...
  // result
  if (!nav2_msgs__action__FollowGPSWaypoints_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Response * msg = (nav2_msgs__action__FollowGPSWaypoints_GetResult_Response *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Response));
  bool success = nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence__init(nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Response * data = NULL;

  if (size) {
    data = (nav2_msgs__action__FollowGPSWaypoints_GetResult_Response *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence__fini(nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence * array = (nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence__destroy(nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence__are_equal(const nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence * lhs, const nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__FollowGPSWaypoints_GetResult_Response * data =
      (nav2_msgs__action__FollowGPSWaypoints_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__init(nav2_msgs__action__FollowGPSWaypoints_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence__init(&msg->request, 0)) {
    nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence__init(&msg->response, 0)) {
    nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__fini(nav2_msgs__action__FollowGPSWaypoints_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence__fini(&msg->request);
  // response
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence__fini(&msg->response);
}
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__are_equal(const nav2_msgs__action__FollowGPSWaypoints_GetResult_Event * lhs, const nav2_msgs__action__FollowGPSWaypoints_GetResult_Event * rhs)
{
  ...
  // request
  if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Event * output)
{
  ...
  // request
  if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Event * msg = (nav2_msgs__action__FollowGPSWaypoints_GetResult_Event *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Event));
  bool success = nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence__init(nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Event * data = NULL;

  if (size) {
    data = (nav2_msgs__action__FollowGPSWaypoints_GetResult_Event *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence__fini(nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence * array = (nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence__destroy(nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence__are_equal(const nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence * lhs, const nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__FollowGPSWaypoints_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__FollowGPSWaypoints_GetResult_Event * data =
      (nav2_msgs__action__FollowGPSWaypoints_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__init(nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!nav2_msgs__action__FollowGPSWaypoints_Feedback__init(&msg->feedback)) {
    nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__fini(nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  nav2_msgs__action__FollowGPSWaypoints_Feedback__fini(&msg->feedback);
}
...
nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__are_equal(const nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage * lhs, const nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!nav2_msgs__action__FollowGPSWaypoints_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage * msg = (nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage));
  bool success = nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence__init(nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage * data = NULL;

  if (size) {
    data = (nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence__fini(nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence * array = (nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence__destroy(nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence__are_equal(const nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence * lhs, const nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage * data =
      (nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__FollowGPSWaypoints_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
