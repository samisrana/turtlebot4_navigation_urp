...
bool nav2_msgs__msg__missed_waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._missed_waypoint.MissedWaypoint", full_classname_dest, 45) == 0);
  }
  nav2_msgs__msg__MissedWaypoint * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of MissedWaypoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav2_msgs.msg._missed_waypoint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MissedWaypoint");
  ...
  nav2_msgs__msg__MissedWaypoint * ros_message = (nav2_msgs__msg__MissedWaypoint *)raw_ros_message;
  {  // index
    PyObject * field = NULL;
