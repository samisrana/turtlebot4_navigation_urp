...
#include "nav2_msgs/msg/detail/particle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav2_msgs::msg::Particle;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav2_msgs
max_serialized_size_key_Particle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Particle__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Particle(full_bounded, is_plain, 0);
...
{
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_Particle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, msg, Particle)() {
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_Particle__handle;
}
