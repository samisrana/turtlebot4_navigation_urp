...
#include "nav2_msgs/msg/detail/costmap_filter_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const nav2_msgs::msg::CostmapFilterInfo & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.filter_mask_topic;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::msg::CostmapFilterInfo & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav2_msgs
max_serialized_size_CostmapFilterInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav2_msgs::msg::CostmapFilterInfo;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav2_msgs
max_serialized_size_key_CostmapFilterInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const nav2_msgs::msg::CostmapFilterInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nav2_msgs::msg::CostmapFilterInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CostmapFilterInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const nav2_msgs::msg::CostmapFilterInfo *>(
...
static size_t _CostmapFilterInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CostmapFilterInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CostmapFilterInfo__callbacks = {
  "nav2_msgs::msg",
  "CostmapFilterInfo",
...
static rosidl_message_type_support_t _CostmapFilterInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CostmapFilterInfo__callbacks,
...
get_message_type_support_handle<nav2_msgs::msg::CostmapFilterInfo>()
{
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_CostmapFilterInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, msg, CostmapFilterInfo)() {
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_CostmapFilterInfo__handle;
}
