...
void dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  dwb_msgs__srv__ScoreTrajectory_Event__init(message_memory);
}

void dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_fini_function(void * message_memory)
{
  dwb_msgs__srv__ScoreTrajectory_Event__fini(message_memory);
}

size_t dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__size_function__ScoreTrajectory_Event__request(
  const void * untyped_member)
{
  const dwb_msgs__srv__ScoreTrajectory_Request__Sequence * member =
    (const dwb_msgs__srv__ScoreTrajectory_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__get_const_function__ScoreTrajectory_Event__request(
...
void * dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__get_function__ScoreTrajectory_Event__request(
  void * untyped_member, size_t index)
{
  dwb_msgs__srv__ScoreTrajectory_Request__Sequence * member =
    (dwb_msgs__srv__ScoreTrajectory_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__fetch_function__ScoreTrajectory_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const dwb_msgs__srv__ScoreTrajectory_Request * item =
    ((const dwb_msgs__srv__ScoreTrajectory_Request *)
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__get_const_function__ScoreTrajectory_Event__request(untyped_member, index));
  dwb_msgs__srv__ScoreTrajectory_Request * value =
    (dwb_msgs__srv__ScoreTrajectory_Request *)(untyped_value);
  *value = *item;
}

void dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__assign_function__ScoreTrajectory_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  dwb_msgs__srv__ScoreTrajectory_Request * item =
    ((dwb_msgs__srv__ScoreTrajectory_Request *)
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__get_function__ScoreTrajectory_Event__request(untyped_member, index));
  const dwb_msgs__srv__ScoreTrajectory_Request * value =
    (const dwb_msgs__srv__ScoreTrajectory_Request *)(untyped_value);
  *item = *value;
}

bool dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__resize_function__ScoreTrajectory_Event__request(
  void * untyped_member, size_t size)
{
  dwb_msgs__srv__ScoreTrajectory_Request__Sequence * member =
    (dwb_msgs__srv__ScoreTrajectory_Request__Sequence *)(untyped_member);
  dwb_msgs__srv__ScoreTrajectory_Request__Sequence__fini(member);
  return dwb_msgs__srv__ScoreTrajectory_Request__Sequence__init(member, size);
}

size_t dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__size_function__ScoreTrajectory_Event__response(
  const void * untyped_member)
{
  const dwb_msgs__srv__ScoreTrajectory_Response__Sequence * member =
    (const dwb_msgs__srv__ScoreTrajectory_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__get_const_function__ScoreTrajectory_Event__response(
  const void * untyped_member, size_t index)
{
  const dwb_msgs__srv__ScoreTrajectory_Response__Sequence * member =
    (const dwb_msgs__srv__ScoreTrajectory_Response__Sequence *)(untyped_member);
...
void * dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__get_function__ScoreTrajectory_Event__response(
  void * untyped_member, size_t index)
{
  dwb_msgs__srv__ScoreTrajectory_Response__Sequence * member =
    (dwb_msgs__srv__ScoreTrajectory_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__fetch_function__ScoreTrajectory_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const dwb_msgs__srv__ScoreTrajectory_Response * item =
    ((const dwb_msgs__srv__ScoreTrajectory_Response *)
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__get_const_function__ScoreTrajectory_Event__response(untyped_member, index));
  dwb_msgs__srv__ScoreTrajectory_Response * value =
    (dwb_msgs__srv__ScoreTrajectory_Response *)(untyped_value);
  *value = *item;
}

void dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__assign_function__ScoreTrajectory_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  dwb_msgs__srv__ScoreTrajectory_Response * item =
    ((dwb_msgs__srv__ScoreTrajectory_Response *)
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__get_function__ScoreTrajectory_Event__response(untyped_member, index));
  const dwb_msgs__srv__ScoreTrajectory_Response * value =
    (const dwb_msgs__srv__ScoreTrajectory_Response *)(untyped_value);
  *item = *value;
}

bool dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__resize_function__ScoreTrajectory_Event__response(
  void * untyped_member, size_t size)
{
  dwb_msgs__srv__ScoreTrajectory_Response__Sequence * member =
    (dwb_msgs__srv__ScoreTrajectory_Response__Sequence *)(untyped_member);
  dwb_msgs__srv__ScoreTrajectory_Response__Sequence__fini(member);
  return dwb_msgs__srv__ScoreTrajectory_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dwb_msgs__srv__ScoreTrajectory_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(dwb_msgs__srv__ScoreTrajectory_Event, request),  // bytes offset in struct
    NULL,  // default value
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__size_function__ScoreTrajectory_Event__request,  // size() function pointer
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__get_const_function__ScoreTrajectory_Event__request,  // get_const(index) function pointer
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__get_function__ScoreTrajectory_Event__request,  // get(index) function pointer
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__fetch_function__ScoreTrajectory_Event__request,  // fetch(index, &value) function pointer
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__assign_function__ScoreTrajectory_Event__request,  // assign(index, value) function pointer
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__resize_function__ScoreTrajectory_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(dwb_msgs__srv__ScoreTrajectory_Event, response),  // bytes offset in struct
    NULL,  // default value
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__size_function__ScoreTrajectory_Event__response,  // size() function pointer
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__get_const_function__ScoreTrajectory_Event__response,  // get_const(index) function pointer
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__get_function__ScoreTrajectory_Event__response,  // get(index) function pointer
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__fetch_function__ScoreTrajectory_Event__response,  // fetch(index, &value) function pointer
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__assign_function__ScoreTrajectory_Event__response,  // assign(index, value) function pointer
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__resize_function__ScoreTrajectory_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_message_members = {
  "dwb_msgs__srv",  // message namespace
  "ScoreTrajectory_Event",  // message name
  3,  // number of fields
  sizeof(dwb_msgs__srv__ScoreTrajectory_Event),
  false,  // has_any_key_member_
  dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_message_member_array,  // message members
  dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_message_type_support_handle = {
  0,
  &dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_dwb_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, ScoreTrajectory_Event)() {
  dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, ScoreTrajectory_Request)();
  dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, ScoreTrajectory_Response)();
  if (!dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_message_type_support_handle.typesupport_identifier) {
    dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t dwb_msgs__srv__detail__score_trajectory__rosidl_typesupport_introspection_c__ScoreTrajectory_service_type_support_handle = {
  ...
  &dwb_msgs__srv__ScoreTrajectory_Request__rosidl_typesupport_introspection_c__ScoreTrajectory_Request_message_type_support_handle,
  &dwb_msgs__srv__ScoreTrajectory_Response__rosidl_typesupport_introspection_c__ScoreTrajectory_Response_message_type_support_handle,
  &dwb_msgs__srv__ScoreTrajectory_Event__rosidl_typesupport_introspection_c__ScoreTrajectory_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, ScoreTrajectory_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, ScoreTrajectory_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, ScoreTrajectory_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_dwb_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, ScoreTrajectory)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, ScoreTrajectory_Event)()->data;
  }
