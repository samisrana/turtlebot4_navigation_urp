...
enum
{
  dwb_msgs__srv__ScoreTrajectory_Event__request__MAX_SIZE = 1
};
// response
enum
{
  dwb_msgs__srv__ScoreTrajectory_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/ScoreTrajectory in the package dwb_msgs.
typedef struct dwb_msgs__srv__ScoreTrajectory_Event
{
  service_msgs__msg__ServiceEventInfo info;
  dwb_msgs__srv__ScoreTrajectory_Request__Sequence request;
  dwb_msgs__srv__ScoreTrajectory_Response__Sequence response;
} dwb_msgs__srv__ScoreTrajectory_Event;

// Struct for a sequence of dwb_msgs__srv__ScoreTrajectory_Event.
typedef struct dwb_msgs__srv__ScoreTrajectory_Event__Sequence
{
