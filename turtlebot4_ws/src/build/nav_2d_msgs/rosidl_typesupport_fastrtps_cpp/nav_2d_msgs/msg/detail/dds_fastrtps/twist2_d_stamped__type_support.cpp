...
#include "nav_2d_msgs/msg/detail/twist2_d_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const nav_2d_msgs::msg::Twist2DStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav_2d_msgs::msg::Twist2DStamped & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav_2d_msgs
max_serialized_size_Twist2DStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav_2d_msgs::msg::Twist2DStamped;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav_2d_msgs
max_serialized_size_key_Twist2DStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const nav_2d_msgs::msg::Twist2DStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nav_2d_msgs::msg::Twist2DStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Twist2DStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const nav_2d_msgs::msg::Twist2DStamped *>(
...
static size_t _Twist2DStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Twist2DStamped(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Twist2DStamped__callbacks = {
  "nav_2d_msgs::msg",
  "Twist2DStamped",
...
static rosidl_message_type_support_t _Twist2DStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Twist2DStamped__callbacks,
...
{
  return &nav_2d_msgs::msg::typesupport_fastrtps_cpp::_Twist2DStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_2d_msgs, msg, Twist2DStamped)() {
  return &nav_2d_msgs::msg::typesupport_fastrtps_cpp::_Twist2DStamped__handle;
}
