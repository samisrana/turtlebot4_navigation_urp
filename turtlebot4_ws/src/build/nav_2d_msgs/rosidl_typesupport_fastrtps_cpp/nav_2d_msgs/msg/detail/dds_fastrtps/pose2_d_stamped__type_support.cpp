...
#include "nav_2d_msgs/msg/detail/pose2_d_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav_2d_msgs::msg::Pose2DStamped;
    is_plain =
      (
...
static size_t _Pose2DStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Pose2DStamped(full_bounded, is_plain, 0);
...
{
  return &nav_2d_msgs::msg::typesupport_fastrtps_cpp::_Pose2DStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_2d_msgs, msg, Pose2DStamped)() {
  return &nav_2d_msgs::msg::typesupport_fastrtps_cpp::_Pose2DStamped__handle;
}
