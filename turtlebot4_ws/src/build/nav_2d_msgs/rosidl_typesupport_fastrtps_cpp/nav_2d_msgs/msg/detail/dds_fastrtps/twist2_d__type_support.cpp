...
#include "nav_2d_msgs/msg/detail/twist2_d__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav_2d_msgs::msg::Twist2D;
    is_plain =
      (
...
static size_t _Twist2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Twist2D(full_bounded, is_plain, 0);
...
{
  return &nav_2d_msgs::msg::typesupport_fastrtps_cpp::_Twist2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_2d_msgs, msg, Twist2D)() {
  return &nav_2d_msgs::msg::typesupport_fastrtps_cpp::_Twist2D__handle;
}
