...
#include "nav_2d_msgs/msg/detail/path2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Path2D__ros_msg_type = nav_2d_msgs__msg__Path2D;
...
size_t get_serialized_size_nav_2d_msgs__msg__Path2D(
  ...
  size_t current_alignment)
{
  const _Path2D__ros_msg_type * ros_message = static_cast<const _Path2D__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav_2d_msgs__msg__Path2D;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav_2d_msgs__msg__Path2D * ros_message = static_cast<const nav_2d_msgs__msg__Path2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav_2d_msgs__msg__Path2D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav_2d_msgs__msg__Path2D * ros_message = static_cast<nav_2d_msgs__msg__Path2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav_2d_msgs__msg__Path2D(cdr, ros_message);
}

static uint32_t _Path2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nav_2d_msgs__msg__Path2D(
      untyped_ros_message, 0));
}

static size_t _Path2D__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_nav_2d_msgs__msg__Path2D(
...
static message_type_support_callbacks_t __callbacks_Path2D = {
  "nav_2d_msgs::msg",
  "Path2D",
...
static rosidl_message_type_support_t _Path2D__type_support = {
