...
set(_exported_dependencies "rclcpp;rclcpp_action;rclcpp_lifecycle;geometry_msgs;sensor_msgs;nav2_msgs;nav_msgs;behaviortree_cpp;tf2;tf2_ros;tf2_geometry_msgs;std_msgs;std_srvs;nav2_util")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(nav2_behavior_tree_INCLUDE_DIRS "${_include_dirs}")
          endif()
