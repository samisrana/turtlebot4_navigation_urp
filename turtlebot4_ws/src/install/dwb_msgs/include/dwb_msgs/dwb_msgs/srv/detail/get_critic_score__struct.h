...
// IWYU pragma: private, include "dwb_msgs/srv/get_critic_score.h"
...
enum
{
  dwb_msgs__srv__GetCriticScore_Event__request__MAX_SIZE = 1
};
// response
enum
{
  dwb_msgs__srv__GetCriticScore_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetCriticScore in the package dwb_msgs.
typedef struct dwb_msgs__srv__GetCriticScore_Event
{
  service_msgs__msg__ServiceEventInfo info;
  dwb_msgs__srv__GetCriticScore_Request__Sequence request;
  dwb_msgs__srv__GetCriticScore_Response__Sequence response;
} dwb_msgs__srv__GetCriticScore_Event;

// Struct for a sequence of dwb_msgs__srv__GetCriticScore_Event.
typedef struct dwb_msgs__srv__GetCriticScore_Event__Sequence
{
