  ...
  dwb_msgs__srv__ScoreTrajectory_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    dwb_msgs__srv__ScoreTrajectory_Request * data =
      (dwb_msgs__srv__ScoreTrajectory_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dwb_msgs__srv__ScoreTrajectory_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dwb_msgs__srv__ScoreTrajectory_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  dwb_msgs__srv__ScoreTrajectory_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    dwb_msgs__srv__ScoreTrajectory_Response * data =
      (dwb_msgs__srv__ScoreTrajectory_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dwb_msgs__srv__ScoreTrajectory_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dwb_msgs__srv__ScoreTrajectory_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
dwb_msgs__srv__ScoreTrajectory_Event__init(dwb_msgs__srv__ScoreTrajectory_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    dwb_msgs__srv__ScoreTrajectory_Event__fini(msg);
    return false;
  }
  // request
  if (!dwb_msgs__srv__ScoreTrajectory_Request__Sequence__init(&msg->request, 0)) {
    dwb_msgs__srv__ScoreTrajectory_Event__fini(msg);
    return false;
  }
  // response
  if (!dwb_msgs__srv__ScoreTrajectory_Response__Sequence__init(&msg->response, 0)) {
    dwb_msgs__srv__ScoreTrajectory_Event__fini(msg);
    return false;
  }
  return true;
...
dwb_msgs__srv__ScoreTrajectory_Event__fini(dwb_msgs__srv__ScoreTrajectory_Event * msg)
{
  ...
  // request
  dwb_msgs__srv__ScoreTrajectory_Request__Sequence__fini(&msg->request);
  // response
  dwb_msgs__srv__ScoreTrajectory_Response__Sequence__fini(&msg->response);
}
...
dwb_msgs__srv__ScoreTrajectory_Event__are_equal(const dwb_msgs__srv__ScoreTrajectory_Event * lhs, const dwb_msgs__srv__ScoreTrajectory_Event * rhs)
{
  ...
  // request
  if (!dwb_msgs__srv__ScoreTrajectory_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!dwb_msgs__srv__ScoreTrajectory_Response__Sequence__are_equal(
  ...
  dwb_msgs__srv__ScoreTrajectory_Event * output)
{
  ...
  // request
  if (!dwb_msgs__srv__ScoreTrajectory_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!dwb_msgs__srv__ScoreTrajectory_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dwb_msgs__srv__ScoreTrajectory_Event * msg = (dwb_msgs__srv__ScoreTrajectory_Event *)allocator.allocate(sizeof(dwb_msgs__srv__ScoreTrajectory_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dwb_msgs__srv__ScoreTrajectory_Event));
  bool success = dwb_msgs__srv__ScoreTrajectory_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
dwb_msgs__srv__ScoreTrajectory_Event__Sequence__init(dwb_msgs__srv__ScoreTrajectory_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dwb_msgs__srv__ScoreTrajectory_Event * data = NULL;

  if (size) {
    data = (dwb_msgs__srv__ScoreTrajectory_Event *)allocator.zero_allocate(size, sizeof(dwb_msgs__srv__ScoreTrajectory_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dwb_msgs__srv__ScoreTrajectory_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        dwb_msgs__srv__ScoreTrajectory_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
dwb_msgs__srv__ScoreTrajectory_Event__Sequence__fini(dwb_msgs__srv__ScoreTrajectory_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      dwb_msgs__srv__ScoreTrajectory_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dwb_msgs__srv__ScoreTrajectory_Event__Sequence * array = (dwb_msgs__srv__ScoreTrajectory_Event__Sequence *)allocator.allocate(sizeof(dwb_msgs__srv__ScoreTrajectory_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dwb_msgs__srv__ScoreTrajectory_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
dwb_msgs__srv__ScoreTrajectory_Event__Sequence__destroy(dwb_msgs__srv__ScoreTrajectory_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dwb_msgs__srv__ScoreTrajectory_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dwb_msgs__srv__ScoreTrajectory_Event__Sequence__are_equal(const dwb_msgs__srv__ScoreTrajectory_Event__Sequence * lhs, const dwb_msgs__srv__ScoreTrajectory_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dwb_msgs__srv__ScoreTrajectory_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dwb_msgs__srv__ScoreTrajectory_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dwb_msgs__srv__ScoreTrajectory_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dwb_msgs__srv__ScoreTrajectory_Event * data =
      (dwb_msgs__srv__ScoreTrajectory_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dwb_msgs__srv__ScoreTrajectory_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dwb_msgs__srv__ScoreTrajectory_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!dwb_msgs__srv__ScoreTrajectory_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
