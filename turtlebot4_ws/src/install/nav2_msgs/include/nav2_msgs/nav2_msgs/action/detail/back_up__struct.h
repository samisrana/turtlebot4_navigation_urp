...
// IWYU pragma: private, include "nav2_msgs/action/back_up.h"
...
enum
{
  nav2_msgs__action__BackUp_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  nav2_msgs__action__BackUp_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/BackUp in the package nav2_msgs.
typedef struct nav2_msgs__action__BackUp_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  nav2_msgs__action__BackUp_SendGoal_Request__Sequence request;
  nav2_msgs__action__BackUp_SendGoal_Response__Sequence response;
} nav2_msgs__action__BackUp_SendGoal_Event;

// Struct for a sequence of nav2_msgs__action__BackUp_SendGoal_Event.
typedef struct nav2_msgs__action__BackUp_SendGoal_Event__Sequence
{
...
enum
{
  nav2_msgs__action__BackUp_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  nav2_msgs__action__BackUp_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/BackUp in the package nav2_msgs.
typedef struct nav2_msgs__action__BackUp_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  nav2_msgs__action__BackUp_GetResult_Request__Sequence request;
  nav2_msgs__action__BackUp_GetResult_Response__Sequence response;
} nav2_msgs__action__BackUp_GetResult_Event;

// Struct for a sequence of nav2_msgs__action__BackUp_GetResult_Event.
typedef struct nav2_msgs__action__BackUp_GetResult_Event__Sequence
{
