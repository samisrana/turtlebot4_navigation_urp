...
class Metaclass_FollowWaypoints_Goal(type):
...
class FollowWaypoints_Goal(metaclass=Metaclass_FollowWaypoints_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.goal_index = kwargs.get(
            'goal_index', FollowWaypoints_Goal.GOAL_INDEX__DEFAULT)
...
class Metaclass_FollowWaypoints_Result(type):
...
class FollowWaypoints_Result(metaclass=Metaclass_FollowWaypoints_Result):
    """
...
class Metaclass_FollowWaypoints_Feedback(type):
...
class FollowWaypoints_Feedback(metaclass=Metaclass_FollowWaypoints_Feedback):
...
class Metaclass_FollowWaypoints_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if FollowWaypoints.Goal.__class__._TYPE_SUPPORT is None:
                FollowWaypoints.Goal.__class__.__import_type_support__()
...
class FollowWaypoints_SendGoal_Request(metaclass=Metaclass_FollowWaypoints_SendGoal_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.goal = kwargs.get('goal', FollowWaypoints_Goal())
...
class Metaclass_FollowWaypoints_SendGoal_Response(type):
...
class FollowWaypoints_SendGoal_Response(metaclass=Metaclass_FollowWaypoints_SendGoal_Response):
...
class Metaclass_FollowWaypoints_SendGoal_Event(type):
...
class FollowWaypoints_SendGoal_Event(metaclass=Metaclass_FollowWaypoints_SendGoal_Event):
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'FollowWaypoints_SendGoal_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'FollowWaypoints_SendGoal_Response'"
        self._response = value


class Metaclass_FollowWaypoints_SendGoal(type):
...
class FollowWaypoints_SendGoal(metaclass=Metaclass_FollowWaypoints_SendGoal):
    from nav2_msgs.action._follow_waypoints import FollowWaypoints_SendGoal_Request as Request
    from nav2_msgs.action._follow_waypoints import FollowWaypoints_SendGoal_Response as Response
    from nav2_msgs.action._follow_waypoints import FollowWaypoints_SendGoal_Event as Event
...
class Metaclass_FollowWaypoints_GetResult_Request(type):
...
class FollowWaypoints_GetResult_Request(metaclass=Metaclass_FollowWaypoints_GetResult_Request):
...
class Metaclass_FollowWaypoints_GetResult_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from nav2_msgs.action import FollowWaypoints
            if FollowWaypoints.Result.__class__._TYPE_SUPPORT is None:
                FollowWaypoints.Result.__class__.__import_type_support__()
...
class FollowWaypoints_GetResult_Response(metaclass=Metaclass_FollowWaypoints_GetResult_Response):
    ...
    def __init__(self, **kwargs):
        ...
        self.result = kwargs.get('result', FollowWaypoints_Result())
...
class Metaclass_FollowWaypoints_GetResult_Event(type):
...
class FollowWaypoints_GetResult_Event(metaclass=Metaclass_FollowWaypoints_GetResult_Event):
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'FollowWaypoints_GetResult_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'FollowWaypoints_GetResult_Response'"
        self._response = value


class Metaclass_FollowWaypoints_GetResult(type):
...
class FollowWaypoints_GetResult(metaclass=Metaclass_FollowWaypoints_GetResult):
    from nav2_msgs.action._follow_waypoints import FollowWaypoints_GetResult_Request as Request
    from nav2_msgs.action._follow_waypoints import FollowWaypoints_GetResult_Response as Response
    from nav2_msgs.action._follow_waypoints import FollowWaypoints_GetResult_Event as Event
...
class Metaclass_FollowWaypoints_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from nav2_msgs.action import FollowWaypoints
            if FollowWaypoints.Feedback.__class__._TYPE_SUPPORT is None:
                FollowWaypoints.Feedback.__class__.__import_type_support__()
...
class FollowWaypoints_FeedbackMessage(metaclass=Metaclass_FollowWaypoints_FeedbackMessage):
    ...
    def __init__(self, **kwargs):
        ...
        self.feedback = kwargs.get('feedback', FollowWaypoints_Feedback())
...
class Metaclass_FollowWaypoints(type):
...
class FollowWaypoints(metaclass=Metaclass_FollowWaypoints):

    # The goal message defined in the action definition.
    from nav2_msgs.action._follow_waypoints import FollowWaypoints_Goal as Goal
    # The result message defined in the action definition.
    from nav2_msgs.action._follow_waypoints import FollowWaypoints_Result as Result
    # The feedback message defined in the action definition.
    from nav2_msgs.action._follow_waypoints import FollowWaypoints_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from nav2_msgs.action._follow_waypoints import FollowWaypoints_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from nav2_msgs.action._follow_waypoints import FollowWaypoints_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from nav2_msgs.action._follow_waypoints import FollowWaypoints_FeedbackMessage as FeedbackMessage
