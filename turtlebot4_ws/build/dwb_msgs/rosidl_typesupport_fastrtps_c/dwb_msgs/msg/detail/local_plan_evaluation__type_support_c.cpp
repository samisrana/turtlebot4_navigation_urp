  ...
  dwb_msgs__msg__LocalPlanEvaluation * ros_message)
{
  ...
  // Field name: twists
  {
    ...
    auto array_ptr = ros_message->twists.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_dwb_msgs__msg__TrajectoryScore(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const dwb_msgs__msg__LocalPlanEvaluation * ros_message = static_cast<const dwb_msgs__msg__LocalPlanEvaluation *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_dwb_msgs__msg__LocalPlanEvaluation(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  dwb_msgs__msg__LocalPlanEvaluation * ros_message = static_cast<dwb_msgs__msg__LocalPlanEvaluation *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_dwb_msgs__msg__LocalPlanEvaluation(cdr, ros_message);
}
