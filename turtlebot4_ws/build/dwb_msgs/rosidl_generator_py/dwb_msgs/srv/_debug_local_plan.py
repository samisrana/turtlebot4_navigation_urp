...
class Metaclass_DebugLocalPlan_Event(type):
...
class DebugLocalPlan_Event(metaclass=Metaclass_DebugLocalPlan_Event):
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'DebugLocalPlan_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'DebugLocalPlan_Response'"
...
class DebugLocalPlan(metaclass=Metaclass_DebugLocalPlan):
    ...
    from dwb_msgs.srv._debug_local_plan import DebugLocalPlan_Event as Event
