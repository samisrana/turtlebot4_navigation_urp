...
[[deprecated("use dwb_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const dwb_msgs::srv::GetCriticScore_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  dwb_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use dwb_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const dwb_msgs::srv::GetCriticScore_Event & msg)
{
  return dwb_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<dwb_msgs::srv::GetCriticScore_Event>()
{
  return "dwb_msgs::srv::GetCriticScore_Event";
}

template<>
inline const char * name<dwb_msgs::srv::GetCriticScore_Event>()
{
  return "dwb_msgs/srv/GetCriticScore_Event";
}
