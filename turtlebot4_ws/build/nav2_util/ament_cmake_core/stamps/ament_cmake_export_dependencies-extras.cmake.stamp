...
set(_exported_dependencies "bondcpp;geometry_msgs;lifecycle_msgs;nav2_msgs;nav_msgs;rcl_interfaces;rclcpp;rclcpp_action;rclcpp_lifecycle;std_msgs;tf2;tf2_geometry_msgs;tf2_ros")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(nav2_util_INCLUDE_DIRS "${_include_dirs}")
          endif()
