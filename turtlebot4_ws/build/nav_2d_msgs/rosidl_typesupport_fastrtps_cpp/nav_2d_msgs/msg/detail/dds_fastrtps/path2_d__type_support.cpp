...
#include "nav_2d_msgs/msg/detail/path2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const nav_2d_msgs::msg::Path2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav_2d_msgs::msg::Path2D & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav_2d_msgs::msg::Path2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav_2d_msgs::msg::Path2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nav_2d_msgs::msg::Path2D *>(
    untyped_ros_message);
...
static size_t _Path2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Path2D(full_bounded, is_plain, 0);
...
{
  return &nav_2d_msgs::msg::typesupport_fastrtps_cpp::_Path2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_2d_msgs, msg, Path2D)() {
  return &nav_2d_msgs::msg::typesupport_fastrtps_cpp::_Path2D__handle;
}
