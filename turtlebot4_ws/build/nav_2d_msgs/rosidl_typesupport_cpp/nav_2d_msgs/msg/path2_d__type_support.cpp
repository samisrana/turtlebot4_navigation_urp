...
static const _Path2D_type_support_symbol_names_t _Path2D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_2d_msgs, msg, Path2D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav_2d_msgs, msg, Path2D)),
  }
};
...
{
  return &::nav_2d_msgs::msg::rosidl_typesupport_cpp::Path2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nav_2d_msgs, msg, Path2D)() {
  return get_message_type_support_handle<nav_2d_msgs::msg::Path2D>();
}
