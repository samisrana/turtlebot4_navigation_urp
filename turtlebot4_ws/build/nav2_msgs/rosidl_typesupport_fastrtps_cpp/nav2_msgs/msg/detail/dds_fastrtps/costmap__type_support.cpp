...
#include "nav2_msgs/msg/detail/costmap__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav2_msgs::msg::Costmap;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_msgs::msg::Costmap *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nav2_msgs::msg::Costmap *>(
    untyped_ros_message);
...
static size_t _Costmap__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Costmap(full_bounded, is_plain, 0);
...
{
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_Costmap__handle;
}
